...
struct msdos_partition {
	uint8_t    bootable;		    /* 0x80 for bootable, 0x0 if not            */
	uint8_t    first_sector_CHS[3];	/* CHS address of first sector in partition */
	uint8_t    partition_type;
	uint8_t    last_sector_CHS[3];	/* CHS address of last sector in partition  */
	uint32_t   first_sector_LBA;	/* LBA of first sector in partition         */
	uint32_t   number_sectors;	    /* number of sectors in partition           */
};